  ...
  return (
    <main className="max-w-4xl mx-auto py-12 px-4 flex flex-col gap-8">
      ...
      <div className="bg-muted rounded-lg p-6 mt-8">
        ...
        <div className="mb-2 text-muted-foreground">Paste your OpenAI API key to enable AI meal suggestions just for you. Your key is stored securely and only used for your requests.</div>
